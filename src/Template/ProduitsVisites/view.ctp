...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Produits Visite'), ['action' => 'edit', $produitsVisite->Produit_id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Produits Visite'), ['action' => 'delete', $produitsVisite->Produit_id], ['confirm' => __('Are you sure you want to delete # {0}?', $produitsVisite->Produit_id)]) ?> </li>
...
<div class="produitsVisites view large-9 medium-8 columns content">
    <h3><?= h($produitsVisite->Produit_id) ?></h3>
