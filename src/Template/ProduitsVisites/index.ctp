    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $produitsVisite->Produit_id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $produitsVisite->Produit_id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $produitsVisite->Produit_id], ['confirm' => __('Are you sure you want to delete # {0}?', $produitsVisite->Produit_id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
